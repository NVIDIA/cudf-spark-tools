# NVIDIA cuDF plugin for Apache Spark User Tools on AWS EMR

This is a guide for the tools for the NVIDIA cuDF plugin for Apache Spark on AWS EMR. At the end
of this guide, the user will be able to run the cuDF plugin tools to analyze the clusters and
...
- In order to be able to run tools that require SSH on the EMR nodes then:
  ...
  - the private `.pem` file then can be passed to the cuDF plugin tools CLI if needed.
...
- For AWS CLI, some environment variables can be set and picked by the cuDF plugin user tools such as:
...
| **tools_jar**                  | Path to a bundled jar including cuDF plugin tool. The path is a local filesystem, or remote S3 url                                                                                                                                                                                                                                                                                                             | Downloads the latest rapids-tools_*.jar from mvn repo                                                                                                                                                                         |    N     |
...
| Option               | Description                                                                                                                                                                                                                                               | Default                                                                                                                                                                                                                       | Required |
|----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| **gpu_cluster**      | The EMR-cluster on which the Spark applications were executed. The argument can be an EMR-cluster or a valid path to the cluster's properties file (json format) generated by the AWS CLI command  `aws emr describe-cluster`                             | None                                                                                                                                                                                                                          | N        |
