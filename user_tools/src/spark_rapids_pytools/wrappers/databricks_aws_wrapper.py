...
"""Wrapper class to run tools associated with the NVIDIA cuDF plugin for Apache Spark on DATABRICKS_AWS."""
...
class CliDBAWSLocalMode:  # pylint: disable=too-few-public-methods
    """
    A wrapper that runs the cuDF plugin tools locally on the dev machine for DATABRICKS_AWS.
    """
...
class DBAWSWrapper:  # pylint: disable=too-few-public-methods
    """
    A wrapper script to run cuDF plugin tools (Diagnostic) on Databricks_AWS.
    """
